...
export default function Dropdown() {
  return (
    <Menu
      as='div'
      className='w-24 h-12 relative flex items-center'
    >
      <Menu.Button className='flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-full hover:bg-[#3E3E3E] border-[#262626] border-2'>
        <ChevronDownIcon className='h-6 text-gray-200' />
      </Menu.Button>
      <Transition
        as={Fragment}
